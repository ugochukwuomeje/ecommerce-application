        ...
        <div class='col-md-9'>
            <div class="box round first">
                ...
                <?php
					...
					<input type="hidden" name="categoryvalue" value="4">
					<tr>
					<td colspan="2" align="center"><input type="submit" id='submit5' class='btn-small btn-primary' name="submit5" value="Disable"></td>
				</tr>
					...
					<center><img src='../../images/ajax-loader.gif' id='disablecategory_loader'> </center>    
			</div>
		</div>	
	</div>
</div>	
