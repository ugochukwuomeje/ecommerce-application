				...
				<hr>
                  ...
                  <?php
					...
					<tr>
						...
						<td>  
								<input type="text" name="newbrandname" class='form-control'>
						</td>
					</tr>
					
					<input type="hidden" name="categoryvalue" value="11">
					<tr>
					<td colspan="4" align="center"><input type="submit" id='submit10' class='btn-small btn-primary' name="submit10" value="Edit Brand"></td>
					</tr>
					...
					<center>
							...
							<img src='../../images/ajax-loader.gif' id='enablebrand_loader'>
					</center>                
			</div>
		</div>	
	</div>
