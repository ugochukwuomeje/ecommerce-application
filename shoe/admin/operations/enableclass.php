        ...
        <div class='col-md-9'>
            <div class="box round first">
                ...
                <hr>
					...
					<td>
						<select name="class" class='form-control class' >
							<option value='0'>Class list</option>
								<?php
									$sql_class = "SELECT * FROM class WHERE status = '0'";
					...
					<input type="hidden" name="categoryvalue" value="16">
					<tr>
					<td colspan="2" align="center"><input type="submit" id='submit16' class='btn-small btn-primary'name="submit2" value="Enable"></td>
				</tr>
