      ...
      <ul class="nav navbar-nav">
		...
		<div class='container-fliud'>
			...
			?>
				...
				<div class='col-md-9'>
				<div><a style='float:left' href='addnewarrivals.php' class='btn btn-small btn-success'>Add New Arrival Product</a></div><br><br>
				<center><h2>REMOVE PRODUCT FROM NEW ARRIVAL</h2></center>
					<?php
					...
					";
						$sql_product = "SELECT * FROM product WHERE newarrival = '1'";
					...
					$product_brand_name = $product_brand_name['brand_title'];
							...
							echo"<tr><td><img src='$image' style='width:40%; height:40%' class='img-responsive'></td><td>$name</td><td>$product_cat_name</td><td>$product_brand_name</td><td>$price</td><td><a class='btn btn-danger btn-small deleteproductnewarrival' role='button' deleteproductid = '$id' ><span class='glyphicon glyphicon-remove'></span>remove</a></tr>";						
						}
