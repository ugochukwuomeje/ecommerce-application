      ...
      <ul class="nav navbar-nav">
		...
		<div class='container-fliud'>
			...
			?>
				...
				<div class='col-md-9'>
				<center><h2>REMOVE FROM RECOMMENDED PRODUCT</h2></center>
					<?php
					...
					";
						$sql_product = "SELECT * FROM product WHERE recommended_product = '1'";
					...
					$product_brand_name = $product_brand_name['brand_title'];
							...
							echo"<tr><td><img src='$image' style='width:40%; height:40%' class='img-responsive'></td><td>$name</td><td>$product_cat_name</td><td>$product_brand_name</td><td>$price</td><td><a class='btn btn-danger btn-small removerecommendedproduct' role='button' deleteproductid = '$id' ><span class='glyphicon glyphicon-remove'></span>remove</a></tr>";						
						}
