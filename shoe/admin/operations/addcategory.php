        ...
        <div class='col-md-9'>
            <div class="box round first">
                ...
                <hr>
					...
					<td>Categoty List</td>
					<td>
						<select name="pcategory" class='form-control category' ></select>
					...
					<input type="hidden" name="categoryvalue" value="1">
					<tr>
					<td colspan="2" align="center"><input type="submit" id='submit2' class='btn-small btn-primary'name="submit2" value="upload"></td>
				</tr>
					...
					<center><img src='../../images/ajax-loader.gif' id='addcategory_loader'> </center>                
			</div>
		</div>	
	</div>
</div>	
