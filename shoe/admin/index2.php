					...
					<h4  style="color:white"> Admin LOGIN</h4>
							...
							<div class="panel-body" >
								<form method="post">
											...
											<div class="row">
												<div class="col-md-12">
													<input type="button" style="float:right" value="login" id="supportlogin" name="supportlogin" class="btn btn-primary ">
												</div>
											</div>
								</form>
								<center><img src="../images/ajax-loader.gif" id="support_loader" ></img></center>
							</div>
