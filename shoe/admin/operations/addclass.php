	...
	include("sidemenu.php");
        ...
        <div class='col-md-9'>
            <div class="box round first">
                <center><h2>
                   Add New product class</h2></center>
                <hr>
					<?php
					...
					<input type="hidden" name="categoryvalue" value="13">
					<tr>
					<td colspan="2" align="center"><input type="submit" id='submit13' class='btn-small btn-primary'name="submit2" value="upload"></td>
				</tr>
