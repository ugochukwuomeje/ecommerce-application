				...
				<hr>
                  ...
                  <?php
					...
					<tr>
						...
						<td>
							<select name="addbrandsubcategory" class='form-control subcategory2' id='subcategory2' >
					...
					<tr>
					<td colspan="4" align="center"><input type="submit" id='submit9' class='btn-small btn-primary' name="submit9" value="Enable Brand"></td>
					</tr>
