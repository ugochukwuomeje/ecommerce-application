        ...
        <div class='col-md-9'>
            <div class="box round first">
                ...
                <hr>
					...
					<input type="hidden" name="categoryvalue" value="15">
					<tr>
					<td colspan="2" align="center"><input type="submit" id='submit15' class='btn-small btn-primary'name="submit2" value="disable"></td>
				</tr>
