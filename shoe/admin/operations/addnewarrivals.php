      ...
      <ul class="nav navbar-nav">
		...
		<div class='container-fliud'>
			...
			?>
				...
				<div class='col-md-9'>
				<div><a style='float:left' href='removenewarrival.php' class='btn btn-small btn-success'>Remove new Arrival Product</a></div><br><br>
				<center><h2>ADD PRODUCT TO NEW ARRIVAL</h2></center>
					...
					";
						$sql_product = "SELECT * FROM product WHERE newarrival = '0'";
					...
					$product_brand_name = $product_brand_name['brand_title'];
							...
							echo"<tr><td><img src='$image' style='width:40%; height:40%' class='img-responsive'></td><td>$name</td><td>$product_cat_name</td><td>$product_brand_name</td><td>$price</td><td><a class='btn btn-success btn-small addproductnewarrival' role='button' deleteproductid = '$id'><span class='glyphicon glyphicon-ok'></span>Add</a></td></tr>";						
						}
